This is a fork of [thamdub/terraform-provider-bitbucket](https://github.com/thamdub/terraform-provider-bitbucket) for fixes and maintenance purposes only 

# Maintenance status

this is a fork of another plugin, but maintained by Runelab S.r.l
